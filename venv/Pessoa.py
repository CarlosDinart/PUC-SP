...
class pessoa:
    ...
    def get_ano_nascimento(self):
        ...
        #variavel = "valor" #posso criar outros atributos validos sem ser acompanhada pelo comando
        #print(variavel)     #self por esta insido dentro do metodo construtor, porem nao consigo
                            # importar por nao esta acompanhado pelo comando self;
